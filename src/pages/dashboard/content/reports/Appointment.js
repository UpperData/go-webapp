...
const types = [
    {
        id: 0,
        name: "Citas cerradas",
        url: "/reporTs/appointment/CLOSED/"
    },
    {
        id: 1,
        name: "Citas pendientes",
        url: "/reporTs/appoiNtment/OpeNEd/"
    },
    {
        id: 2,
        name: "Citas APS",
        url: "/rePOrTs/appoiNtmenT/ApS/"
    },
    {
        id: 3,
        name: "Citas Domiciliarias",
        url: "/rePOrTs/aPpoiNtmenT/DOMIciLIO/"
    }
]
        ...
        { 
            ...
            renderCell: (cellValues) => {
                ...
                return <Typography sx={{fontWeight: 'normal', mb:0}} variant="body">
                    {moment(data.row.fecha).format("DD/MM/YYYY")}
                </Typography>
            }
        },
        { 
            ...
            renderCell: (cellValues) => {
                let data = cellValues;
                return <Typography sx={{fontWeight: 'normal', mb:0}} variant="body">
                    {moment(data.row.fecha).format("hh:mm A")}
                </Typography>
            }
        },
        { 
            ...
            renderCell: (cellValues) => {
                let data = cellValues;
                return <Typography sx={{fontWeight: 'normal', mb:0}} variant="body">
                    {data.row.patient.nombre+" "+ data.row.patient.apellido}
                </Typography>
            }
        }
    ];
